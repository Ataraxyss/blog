        ...
        <tbody>
          <tr">
            <?php include("blocks/navigation.php"); ?>
              ...
              {
                  $result = $connection -> query("INSERT INTO `data` (`title`, `meta_description`, `meta_keywords`,`description`, `text`, `category`, `view`, `author`, `img`, `data`) VALUES ('$title', '$metadescription', '$metakeywords', '$description', '$text', '$category', '$view', '$author', '$icon', '$data')");

                  if ($result == 'true')
                  {
                      echo "<p>Your article was added successfuly</p>";
                  }
                  else
                  {
